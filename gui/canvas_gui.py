...
def same_subnet(ip1, ip2, mask):
    """Verifica si dos direcciones IP pertenecen a la misma subred."""
...
class Device:
    ...
    def __init__(self, canvas, x, y, name, image_path, app_ref):
        """Inicializa un nuevo dispositivo en el lienzo."""
    ...
    def bind_events(self):
        """Vincula los eventos del mouse a las acciones del dispositivo."""
    ...
    def on_double_click(self, event):
        """Maneja el evento de doble clic en el dispositivo."""
        self.app.open_config_window(self)

    def move(self, event):
        """Mueve el dispositivo en el lienzo y actualiza sus conexiones."""
        dx = event.x - self.x
        dy = event.y - self.y
    ...
    def on_click(self, event):
        """Maneja el evento de clic en el dispositivo."""
        self.app.device_clicked(self)

class NetworkSimApp:
    def __init__(self):
        """Inicializa la aplicación principal del simulador de red."""
        self.root = tk.Tk()
    ...
    def add_buttons(self):
        """Añade los botones de la barra de herramientas a la aplicación."""
    ...
    def load_network(self):
        """Carga una configuración de red desde un archivo JSON."""
    ...
    def toggle_delete_mode(self):
        """Activa o desactiva el modo de eliminación de dispositivos."""
    ...
    def demo_send_packet(self):
        """Demuestra el envío de un paquete entre dos dispositivos."""
    ...
    def device_clicked(self, device):
        """Maneja los clics en un dispositivo, para selección o eliminación."""
        if self.delete_mode:
    ...
    def connect_devices(self, d1, d2):
        """Crea una conexión visual y lógica entre dos dispositivos."""
        x1 = d1.x + 25
        y1 = d1.y + 25
        x2 = d2.x + 25
        y2 = d2.y + 25
    ...
    def connection_clicked(self, event):
        """Maneja los clics en una conexión para seleccionarla/deseleccionarla."""
    ...
    def log(self, message):
        """Muestra un mensaje en el panel de logs de la aplicación."""
    ...
    def find_path(self, start_name, end_name):
        """Encuentra una ruta entre dos dispositivos usando BFS."""
    ...
    def send_packet(self, start_name, end_name):
        """Inicia el proceso de envío de un paquete entre dos dispositivos."""
    ...
    def validate_routing_protocols(self, path):
        """Valida la consistencia de los protocolos de enrutamiento en una ruta."""
    ...
    def animate_packet(self, packet, devices, path, index):
        """Anima el movimiento de un paquete a lo largo de una ruta en el lienzo."""
        if index >= len(path) - 1:
        ...
        def step_move():
            """Realiza un paso de la animación del movimiento del paquete."""
            nonlocal step
            if step < steps:
    ...
    def delete_device(self, device):
        ...
        """Elimina un dispositivo del lienzo y de la lógica de la red."""
        ...
        if device.name in self.graph:
            for neighbor in self.graph[device.name]:
                if neighbor in self.graph and device.name in self.graph[neighbor]:
                    self.graph[neighbor].remove(device.name)
            del self.graph[device.name]
    ...
    def get_all_devices(self):
        ...
        """Devuelve una lista de todos los dispositivos actualmente en el simulador."""
        devices = []
    ...
    def open_config_window(self, device):
        """Abre una ventana para configurar las propiedades de un dispositivo."""
        ...
        def save():
            """Guarda la configuración modificada del dispositivo desde la ventana de configuración."""
